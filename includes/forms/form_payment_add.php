        ...
        <div class="content">
            <form method="POST">
                ...
                <select name="payment_method" class="payment">
                    <option selected disabled>Escolha o método de pagamento</option>
                ...
                <input type="number" name="payment_amount" placeholder="Quantia" required autocomplete="off" min="0" step=".01" class="value"><br><br><br>
