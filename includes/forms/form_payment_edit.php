    ...
    <div class="window">
        ...
        <div class="content">
            <form method="POST">
                ...
                <select name="payment_method" class="payment">
                    <?php
                        if ($payment -> method == 'Dinheiro')
                            echo '<option selected>'.$payment -> method.'</option>
                        ...
                        if ($payment -> method == 'Não informado')
                            echo '<option selected>'.$payment -> method.'</option>
                                  <option value="money">Dinheiro</option>
                                  <option value="credit_card">Crédito</option>
                                  <option value="debit_card">Débito</option>
                ...
                <input type="number" name="payment_amount" placeholder="Quantia" required autocomplete="off" min="0" step=".01" class="value"
                    <?php 
