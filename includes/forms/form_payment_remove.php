    ...
    <div class="window">
        ...
        <div class="content">
            <form method="POST">
                ...
                <input type="number" name="payment_id" placeholder="ID" min="0" required autocomplete="off" class="payment"><br>

                <input type="checkbox" id="confirm_removal" name="confirm_payment_removal" value="true" required autocomplete="off">
                <label for="confirm_removal" class="label_checkbox">Confirmo que desejo remover este pagamento</label><br><br><br>
